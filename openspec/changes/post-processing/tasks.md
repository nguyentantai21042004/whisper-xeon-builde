...
- [ ] 1.1 Create `maintenance_prune.py` script
    - [ ] Define whitelist (Dockerfile, src, ggml, include, build configs, essential scripts)
...
- [ ] 1.2 Execute pruning script
    - [ ] Run script to clean up repository
    - [ ] Verify essential files remain and project still builds
